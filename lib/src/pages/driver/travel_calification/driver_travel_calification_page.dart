...
import 'package:move_app_1/src/pages/driver/travel_calification/driver_travel_calification_controller.dart';
import 'package:move_app_1/src/widgets/button_app.dart';

class DriverTravelCalificationPage extends StatefulWidget {
  @override
  _DriverTrvelCalificationPageState createState() =>
      _DriverTrvelCalificationPageState();
}

class _DriverTrvelCalificationPageState
    extends State<DriverTravelCalificationPage> {
  DriverTraveCalificationController _con = DriverTraveCalificationController();
